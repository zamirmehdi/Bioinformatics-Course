...
- [Assignment Questions](#-assignment-questions)
  - [Question 1: Biological Terminology](#question-1-biological-terminology)
  - [Question 2: DNA-Cell Relationship](#question-2-dna-cell-relationship)
  - [Question 3: Functional DNA Segments](#question-3-functional-dna-segments)
...
### Question 1: Biological Terminology
...
#### 1.2 Gene Diversity (تنوع ژنتیکی)
...
### Question 2: DNA-Cell Relationship
...
#### Part B: Does DNA Alone Determine Function?
...
**Evidence to Discuss:**
1. **Identical Twins:** Same DNA, different traits over time
2. **Cell Differentiation:** Liver cells vs. neuron cells (same genome, different functions)
3. **Environmental Factors:** Epigenetics, external signals
4. **Gene Regulation:** Not all genes are "turned on" simultaneously
...
### Question 3: Functional DNA Segments
...
**Vestigial Traits (باقیمانده‌های ژنتیکی):**
...
### Platform
- **System:** Quera Platform
- **Class Code:** `Bio1400`
- **Registration:** Use class key to enroll
- **Submission:** Through Quera interface

### Format Requirements

**1. File Format:**
```
Filename: HW1_StudentNumber_FirstnameLastname.pdf
Example: HW1_9731087_AmirmehdiZarrinnezhad.pdf
```

**2. Content Quality:**
- ✅ Answers must be in **your own words** (no copy-paste)
- ✅ Demonstrate understanding through explanation
- ✅ Cite sources if referencing specific studies
- ✅ Clear, readable formatting (typed or high-quality scan)

**3. Submission Method:**
- Single PDF file
- Uploaded to Quera platform
- Before deadline (see Important Notes)
...
```
If any copying is detected (theoretical OR programming):
→ Both students receive -100% grade
→ No exceptions
→ Take this seriously to avoid problems
```

**What Constitutes Plagiarism:**
- ❌ Copying from internet sources without understanding
- ❌ Submitting identical or highly similar answers
- ❌ Paraphrasing without genuine comprehension
- ❌ Sharing answers with classmates

**Acceptable Practices:**
- ✅ Reading multiple sources for understanding
- ✅ Discussing concepts with classmates (but write independently)
- ✅ Asking instructors for clarification
- ✅ Using your own words and examples

### Deadline

**Due Date:** 16/12/1400 (Persian calendar)

**Late Submission Policy:**
- Grace period: Up to 2 days after deadline
- Penalty: **-1% per hour** of delay
- Maximum grace period: 48 hours
- After grace period: Solutions posted, no credit given

**Calculation Example:**
```
6 hours late: -6% penalty
1 day late: -24% penalty
2 days late: -48% penalty
>2 days late: 0% (no credit)
```

### Questions & Support

**Contact for Questions:**
- 📧 Email: `mmnafar57@gmail.com`
- Response time: Typically within 24-48 hours
- Include student ID and specific question
...
**b) Gene Diversity:**
Total collection of genetic characteristics in a species' gene pool, contributing to:
- Population adaptation to environments
- Species resilience to changes
- Evolutionary potential

**c) Gene Expression:**
Process of producing functional gene products (proteins/RNA) from DNA through:
...
### Question 4: Vestigial Traits in Humans

**Examples Provided:**
1. Coccyx (tailbone) - remnant of tail
2. Wisdom teeth - for grinding tough plant materials
3. Little toe - diminishing utility
4. Plica semilunaris - third eyelid remnant
5. Auricular muscles - ear movement control
6. Body hair / goosebumps - temperature regulation
7. Certain head muscles - repurposed functions
8. Appendix - cellulose digestion remnant
...
[1: Basic Biology](.) | [2: Sequence Alignment](../2-%20Pairwise%20Sequence%20Alignment) | [3: MSA & DB Search](../3-%20Multiple%20Sequence%20Alignment%20-%20DB%20Search) | [4: Profile HMM](../4-%20Profile%20-%20Hidden%20Markov%20model) | [5: Phylogenetic Trees](../5-%20Phylogenetic%20Trees) | [Final: Virus Classification](../Virus%20Classification%20(Final%20Project))
